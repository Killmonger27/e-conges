<x-adm-layout>
    <div class="main-content container-fluid">
        <div class="page-title text-center">
            <div class="row">
                <div class="col-12">
                    <h3>Détails de ma demande</h3>
                    <p class="text-subtitle text-muted">Consultez toutes les informations relatives à votre demande.</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-center mt-4">
                        <div class="col-md-8 text-center">
                            <a href="{{ route('mesdemandes.index') }}" class="btn btn-primary">Retour à la liste de mes demandes</a>
                        </div>
                    </div>
                </div>
            </div>
