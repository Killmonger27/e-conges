<x-adm-layout>
    <div class="main-content container-fluid">
        <div class="page-title text-center">
            <div class="row">
                <div class="col-12">
                    <h3>Modifier une demande en cours</h3>
                    <p class="text-subtitle text-muted">Modifiez les informations de la demande en tant que GRH.</p>
                </div>
            </div>
        </div>
        ...
        <section class="section d-flex justify-content-center">
            <div class="card w-75">
                <div class="card-body">
                    <form action="{{ route('grh.update', $demande->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('demandes.show', $demande->id) }}" class="btn btn-secondary">Annuler</a>
                        </div>
                    </form>
                </div>
            </div>
