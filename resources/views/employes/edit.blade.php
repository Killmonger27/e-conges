                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nom" name="nom"
                                        value="{{ old('nom', $employe->nom) }}" placeholder="Nom de l'employé" required>
                                </div>
                                <div class="form-group">
                                    <label for="prenom">Prénom</label>
                                    <input type="text" class="form-control" id="prenom" name="prenom"
                                        value="{{ old('prenom', $employe->prenom) }}" placeholder="Prénom de l'employé"
                                        required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sexe" name="sexe" required>
                                        <option value="homme"
                                            {{ old('sexe', $employe->sexe) === 'homme' ? 'selected' : '' }}>Homme
                                        </option>
                                        <option value="femme"
                                            {{ old('sexe', $employe->sexe) === 'femme' ? 'selected' : '' }}>Femme
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="{{ old('email', $employe->email) }}" placeholder="Email de l'employé"
                                        required>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type" required>
                                        <option value="employe"
                                            {{ old('type', $employe->type) === 'employe' ? 'selected' : '' }}>Employé
                                        </option>
                                        <option value="chef de service"
                                            {{ old('type', $employe->type) === 'chef de service' ? 'selected' : '' }}>
                                            Chef de service</option>
                                        <option value="grh"
                                            {{ old('type', $employe->type) === 'grh' ? 'selected' : '' }}>GRH</option>
                                    </select>
                                </div>
                            </div>
                        </div>
